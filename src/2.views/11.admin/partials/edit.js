...
const EditReserve = ({ isOpen, setIsOpen, editItem }) => {
    ...
    async function save() {
        ...
        try {
            ...
            let value = (await callW3Api("/admin/edit/reserve", { name: name, address: saveAddress, duration: duration, signature: localStorage.getItem("accountSignature" + address) }));
            console.log(value)
            if (value == "ok") {
                setLoading("")
                setSuccess(true);
                    ...
                    <Dialog.Panel className="mx-auto flex justify-center items-center rounded-3xl overflow-y-scroll">
                        <div className={darkMode ? "dark" : ""}>
                            ...
                            <div className="md:w-[550px] max-h-[90vh] py-10 md:py-6 px-10 md:px-10 bg-white dark:bg-dark800 border border-dark700 rounded-3xl text-white dark:text-white">
                                ...
                                <div className="mt-4">
                                    <p className="text-3xl font-bold">Edit reserve</p>
                                    <p className="text-gray-500 mt-2 dark:text-zinc-400">Edit name to reserve</p>
                                </div>
                                ...
                                <div className="mt-8 pb-6">
                                    <div className="mt-4 grid grid-cols-1 gap-x-6 gap-y-10">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" className="bg-zinc-100 dark:bg-dark800 border-2 border-zinc-200 dark:border-dark700 text-black dark:text-white text-md w-full text-start rounded-xl py-3 px-4 mt-2 placeholder:text-dark500 outline-none" placeholder="Enter name here..." value={newName} readOnly={true} />
                                        </div>
                                    ...
                                    {success ? (
                                        <div className=" pb-0">
                                            <div className="flex flex-row items-center pb-6 gap-x-2">
                                                ...
                                                <p className="text-main font-bold text-sm">Successful edited</p>
                                            </div>
                                        </div>
                                    ) : (null)}
