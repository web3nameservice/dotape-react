...
import BgImg from "./1.resources/3.files/images/bg_alt.png";
import BgVid from "./1.resources/3.files/images/bg1.mp4";
...
class Main extends React.Component {
  ...
  render() {
    return (
      <div style={{}} className="min-h-screen bg-black" style={{ backgroundImage: `url()`, backgroundPosition: "center center", backgroundSize: "cover", backgroundAttachment: "fixed" }}>
